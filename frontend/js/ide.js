...
const AUTHENTICATED_CE_BASE_URL = `http://${defaultHost}:2358`;
const AUTHENTICATED_EXTRA_CE_BASE_URL = `http://${defaultHost}:2358`;

var AUTHENTICATED_BASE_URL = {};
AUTHENTICATED_BASE_URL[CE] = AUTHENTICATED_CE_BASE_URL;
AUTHENTICATED_BASE_URL[EXTRA_CE] = AUTHENTICATED_EXTRA_CE_BASE_URL;

const UNAUTHENTICATED_CE_BASE_URL = `http://${defaultHost}:2358`;
const UNAUTHENTICATED_EXTRA_CE_BASE_URL = `http://${defaultHost}:2358`;
...
def main():\n\
    print('Welcome to the Secure Programming Exam System!')\n\
    \n\
    # Example: Read two numbers from standard input\n\
    try:\n\
        a = int(input())\n\
        b = int(input())\n\
